...
void cubeMesh(float* mesh)
{
    ...
    const int patterns[6][2][3] = {
        {{1, 3, 2}, {1, 2, 0}}, {{3, 1, 0}, {3, 0, 2}}, {{1, 0, 2}, {1, 2, 3}},
        {{3, 2, 0}, {3, 0, 1}}, {{0, 1, 3}, {0, 3, 2}}, {{1, 0, 2}, {1, 2, 3}}};

    // all faces in cube are defined by one fixed coordinate which has the same
    // value for all coordinates fixed is the axis which is fixed
